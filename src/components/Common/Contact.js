      ...
      <section id="contact" className="contact-area ptb-80 bg-f6f6f6">
        <div className="container">
          ...
          >
            ...
            <p>
            Send us a quick message about what your business needs, 
            and we’ll get back to you within a day to schedule a consultation 
            and get you on the road to growth and success.
            </p>
          </div>
              ...
              <div className="contact-info">
                <ul>
                  ...
                  <li>
                    ...
                    <a href="mailto:addax@gmail.com">info@stackedmarketing.com</a>
                  </li>
                  <li>
